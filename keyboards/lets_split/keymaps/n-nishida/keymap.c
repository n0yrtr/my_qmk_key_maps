...
[_QWERTY] = LAYOUT_ortho_4x12(
   ...
   _______, _______, KC_LALT, CTL_T(KC_ESC), GUI_T(KC_ENT), SFT_T(KC_SPC),  LOWER,   RAISE,   RALT_T(KC_BSPC), KC_RALT, _______, _______  \
),
...
[_LOWER] = LAYOUT_ortho_4x12( \
  ...
  _______, _______, _______, _______, KC_TAB, KC_BSPC, _______, _______, KC_MNXT,KC_VOLD, KC_VOLU, KC_MPLY \
),
...
[_RAISE] = LAYOUT_ortho_4x12( \
  ...
  _______, _______, _______, _______, KC_LALT, KC_DEL,  _______, _______, KC_MNXT, KC_VOLD, KC_VOLU,       KC_MPLY        \
),
