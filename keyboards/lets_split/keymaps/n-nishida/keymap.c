...
[_QWERTY] = LAYOUT_ortho_4x12(
   ...
   _______, _______, KC_LALT, KC_LGUI, KC_LCTL, KC_SPC,  LOWER,   RAISE,   KC_RALT, KC_DOWN, _______, _______  \
),
...
[_RAISE] = LAYOUT_ortho_4x12( \
  ...
  _______, _______, _______, _______, KC_LALT, KC_ENT,  _______, _______, KC_MNXT, KC_VOLD, KC_VOLU,       KC_MPLY        \
),
